...
def move(speed, distance, is_forward ):
	...
	if(cmd_vel_topic=='turtle1/cmd_vel'):
...
def circle():
	...
	while(i<100):
		...
		if((i%2)==0):
			...
			velocity_message.linear.x=rospy.get_param("/controller_2/linear_speed")

			velocity_message.angular.z=rospy.get_param("/controller_2/angular_speed")
			cmd_vel_topic = "turtle2/cmd_vel"
...
if __name__ == '__main__':
	try:
		...
		#move(vec_linear1,10, True )
		#move(vec_linear2,2, True  )
